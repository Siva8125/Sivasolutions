			...
			<center>
				...
				<div class="panel panel-default">
					...
					<%
						...
						HRMService service = new HRMServiceImplementation();
					...
					<div class="table displaytable1">
						<div class="scroll1">
							<table align=center>
								<tr>
									...
									<td id="header" colspan="24"><h1>Employee Details</h1></td>
								</tr>
								<tr>
									<th>Employee Id</th>
									<th>Employee Name</th>
								...
								<tr>
									...
									<td><%=bean.getPanNumber()%></td>
									<td><%=bean.getPassportNumber()%></td>
						...
						<br></br> <br></br> <input type=submit
							onclick="window.location='http://localhost:8006/DhatriHRM_Web/index.jsp';"
							value="Back" class="button"> <a href="openingIndexPage">Back</a>
						<hr>
						<%-- <% }
