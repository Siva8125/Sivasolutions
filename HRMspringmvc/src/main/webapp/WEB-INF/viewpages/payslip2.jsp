<%@page import="com.hrm.springmvc.entity.bean.PaySlipBean"%>
...
<body>
	<page size="A4"> <%
 	double ctc = 0.0;
 	Object sessionObj = request.getAttribute("PaySlipObj123");
 	if (sessionObj == null) {
 ...
 %>
	...
	<div class="page">
		...
		<div class="headtext" id="date">
			<table>
				<tr>
					<td align="right" class="padding">Payslip for the month of:
						<%=new SimpleDateFormat("dd-MM-yyyy").format(new java.util.Date())%></td>

					<td class="padding">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No.of
						working Days:31</td>
				</tr>
			</table>
		...
		<div class="backgrouondColor">
			<table>
				<tr>
					<td class="padding"><br>EmpName:<br> <br></td>
					<br>
					<br>
				...
				<tr>
					<td class="padding"><br>Date of Joining:<br> <br></td>
		...
		<div class="backgrouondColor2">
			<table>
				<tr>
					<td class="padding"><br>Basic Salary:<br> <br></td>
				...
				<tr>
					...
					<td class="padding"><br>ProfessionalTax:<br> <br></td>
				...
				<tr>
					<td class="padding"><br>Conveyance:<br> <br></td>
				...
				<tr>
					<td class="padding"><br>HRA:<br> <br></td>
					<td class="padding1"><%=hra%></td>
					<td class="padding2"><br>SpecialAllowance:<br> <br></td>
					<td class="padding2"><%=specialAllowance%></td>

				</tr>

				<tr>
					<td class="padding"><br>CityCompensatoryAll:<br> <br></td>
				...
				<tr>
					<td class="padding"><br>Medical:<br> <br></td>
		...
		<p class="aligncenter">
			...
			Hyderabad: 500 072, Telangana, India<br> Phone: +91 40 6591
			3555, 6555 7888 website: <a href="www.dhatriinfo.com">
