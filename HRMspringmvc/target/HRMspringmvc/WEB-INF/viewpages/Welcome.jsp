...
<form action="openinglogout" method="post" >
  <input type="submit" value="Logout">
</form>
<H1><a href="openingIndexPage">Dhatsol IT Solutions</a> </H1>
<ul>
 <li><a> Employee </a> 
   <ul>
...
<h1 style="text-align:left;color:black;background-color:white;width:200px"><a href="openingUserUpdate"> ProfileUpdate</a></h1>
</body>
</html>