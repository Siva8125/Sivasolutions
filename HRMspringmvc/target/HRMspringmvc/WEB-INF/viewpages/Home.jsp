			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active"><a class="nav-link"
						href="openingIndexPage">Home <span class="sr-only">(current)</span>
					</a></li>
					<li class="nav-item"><a class="nav-link" href="#myModal"
						class="trigger-btn" data-toggle="modal">Login</a></li>

					<li class="nav-item"><a class="nav-link" href="openingAboutUs">About</a>
					</li>
				</ul>
			</div>
		</div>
		...
		<div class="modal-dialog modal-login">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form:form modelAttribute="loginObj" action="LoginServlet">
						<div class="form-group">
							<i class="fa fa-user"></i> <input type="text"
								onkeypress="clearForm()" id="loginId" name="employeeId"
								class="form-control" placeholder="EmployeeId"
								required="required">
						</div>
						<div class="form-group">
							<i class="fa fa-lock"></i> <input type="password"
								class="form-control" onkeypress="clearForm()" id="Password"
								name="mobileNumber" placeholder="Enter password"
								required="required">
						</div>
						<div class="form-group">
							<p>Type</p>
							<select name="role" class="form-control" onkeypress="clearForm()"
								id="type">
