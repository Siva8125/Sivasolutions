...
Trip</label> <br> <label for="fromcity">From City:</label> <select
name="fromcity" id="From City">
...
</select> <br> <label for="tocity">Destination City:</label> <select
name="tocity" id="Destination City">
<option value="Select City">Select City</option>
<option value="Hyderabad">Hyderabad</option>
...
type="date"> <br> <input type="submit" value="Search">
