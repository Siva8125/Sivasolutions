...
<a style="color: black" href="loginpageopening">User Login
</button>
<button
style="width: 410px; height: 100px; font-family: 'Brush Script MT', cursive; font-size: 50px; background-color: red">
<a style="color: black" href="registerpageopening">New User
Registration
</button>
<button
style="width: 410px; height: 100px; font-family: 'Brush Script MT', cursive; font-size: 50px; background-color: red">
<a style="color: black" href="searchflightpageopening">Search Flights
</button>
<br>
<button
style="width: 410px; height: 100px; font-family: 'Brush Script MT', cursive; font-size: 50px; background-color: red">
